...
vector_db = QdrantVectorStore.from_existing_collection( # Reuse the existing collection ...>> mane j collection already ase
...
search_results = vector_db.similarity_search(query=user_query) #according to user query it search the similarity chunks
